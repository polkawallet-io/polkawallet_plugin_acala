...
class LoanHistoryPage extends StatefulWidget {
  ...
  @override
  _LoanHistoryPage createState() => _LoanHistoryPage();
}
      ...
      body: SafeArea(
        child: Observer(
          builder: (_) {
            ...
            List<TxLoanData> list =
                widget.plugin.store.loan.txs.reversed.toList();
//            Map<int, BlockData> blockMap = store.assets.blockMap;
            ...
            return ListView.builder(
              ...
              itemBuilder: (BuildContext context, int i) {
                ...
                LoanType loanType = widget.plugin.store.loan.loanTypes
